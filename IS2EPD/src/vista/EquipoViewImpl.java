...
//Con este evento controlamos que hemos clicados en una fila de la tabla
    ...
    protected void refresh() {
        ...
        tableModel.setEquipos(getController().getModel().obtenerEquipos());
    }

    protected void fireNuevoContactoGesture(String nombre, String pais, String pos_grupo, String grupo) {
        //Actividad B)
        //Capas relajadas
        //Como la vista conoce al modelo le preguntamos si este equipo puede ser añadido
        int error = getModel().comprobarEquipo(nombre, pais, pos_grupo, grupo);
        //depende de la respuesta que nos dé
        System.out.println(error);
        if (error == 1) {
            javax.swing.JOptionPane.showMessageDialog(new JInternalFrame(), "¡ERROR, este equipo ya está en la lista!");
        } else if (error == 2) {
            javax.swing.JOptionPane.showMessageDialog(new JInternalFrame(), "¡ERROR, el grupo " + grupo + " solo admite 2 equipos!");
        } else if (error == 3) {
            javax.swing.JOptionPane.showMessageDialog(new JInternalFrame(), "¡ERROR, esa posición ya está cubierta!");
        } else {
            getController().nuevoEquipoGesture(nombre, pais, pos_grupo, grupo);
            javax.swing.JOptionPane.showMessageDialog(new JInternalFrame(), "¡Equipo añadido con éxito!");
        }
